...
- Typed property rows use `clickhouse.PropertyBatchWriter`; it stays separate from event writes until cross-table retry and duplicate semantics are finalized.
